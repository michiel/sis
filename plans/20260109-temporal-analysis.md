...
- [ ] Versioned graph extraction implemented
- [ ] Versioned scanning and ML inference
- [ ] Temporal aggregation and explanations
- [ ] CLI flag `--ml-temporal`
- [ ] Report/JSONL outputs
- [ ] Non-ML temporal signals and output
- [ ] Fixtures and tests
- [ ] Update `USAGE.md`
